...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        $parent = Category::getParent()->orderBy('id', 'ASC')->get();


        //MENGAMBIL SEMUA LIST CATEGORY (TIDAK HANYA PARENT
        //$parent = Category::all();
    ...
    public function edit($id)
    {
        ...
        $parent = Category::getParent()->orderBy('id', 'ASC')->get(); //INI SAMA DENGAN QUERY YANG ADA PADA METHOD INDEX
